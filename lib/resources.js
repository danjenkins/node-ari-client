...
function attachOperations () {
  ...
  function attachOperation (operation) {
    ...
    var proxyDialogId = self.proxyDialogId;
    ...
    function callSwagger (/* args..., callback */) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        if (self._client._proxy) {
          var info = self._client._swagger.apis[self._resource].operations[operation];

          self._client._proxy.send(self.proxyDialogId || proxyDialogId, info.path, info.method, options, processResponse, swaggerError);
          return;
        }
        ...
        function processResponse (response) {
          ...
          if (result instanceof Object) {
            result.proxyDialogId = proxyDialogId;
          }
